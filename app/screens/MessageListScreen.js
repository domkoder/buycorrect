    ...
    //   <SafeAreaView>
        <View style={styles.container}>
          <View style={styles.searchContainer}>
            <Feather style={{ position:'absolute', left: 30, zIndex: 1}} name="search" size={16} />
            <TextInput value={searchText} onChangeText={setSearchText} style={styles.search} placeholder="" />

            {searchText ? (
                <TouchableOpacity onPress={handleCancel} style={{ position:'absolute', right: 30, zIndex: 1}}>
